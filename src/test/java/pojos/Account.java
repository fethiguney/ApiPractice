...
public class Account {
    ...
    public Account(Integer id, String description, String balance, String accountType, String accountStatusType, String createDate, String closedDate, Object employee, Object accountlogs) {
        this.id = id;
